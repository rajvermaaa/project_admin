...
async function bootstrap() {
  ...
  app.useGlobalPipes(
    new ValidationPipe({
      ...
      transform: true, //auto-convert json into ts instances based on dto
      forbidUnknownValues: true,// throw error on unknown fields
      stopAtFirstError: true, // valadtion of property stop after first error
  ...
  const config = new DocumentBuilder()
    ...
    .addBearerAuth()
    .build();
  //Used to create a swagger document for our nestjs api
